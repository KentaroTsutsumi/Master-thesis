...
We also calculated the values of $\mu^{\ast}$ based on the McMillan-Allen-Dynes formula (\ref{eq:Allen})
using calculated $\lambda, \omega_{\rm ln}$ listed in Table\ref{tab:results} to reproduce the $T_c$ 
calculated in SCDFT. 
The calculated values of $\mu^{\ast}$ with the effect of spin fluctuations for V and Nb are 
0.288 and 0.269, respectively. In the analyses in ME theory, this value is conventionally
