...
In the original paper, this term is neglected based on the following assumption.
...
On the other hand, this assumption is not valid in case of elemental metals such as Al and the 
