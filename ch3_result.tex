...
The ferromagnetic fluctuations come from the exchange effect\cite{Berk1966}: Two electrons having same spins are 
...
since one is obliged to apply the adiabatic approximation to $f^{\rm xc}(\bm r_1,t_1, \bm r_2,t2)$
%
\begin{equation}
...
\end{equation}
%
$f^{\rm xc}$ becomes $\omega$-independent after the Fourier transformation.
