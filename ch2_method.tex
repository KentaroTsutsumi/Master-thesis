...
\end{equation}
%
The diagrammatic expression of $F^1_{\rm xc}$ and $F^2_{\rm xc}$ is depicted in 
...
(see (\ref{eq:def-fxc})).
The exchange-correlation kernel arising from $F^1_{\rm xc}$ is nondiagonal and its form is
%
\begin{equation}
	{\mathcal K}^{\rm ph}_{ij} = \frac{2}{\tanh[(\beta/2)\xi_i]\tanh[(\beta/2)\xi_j]}
...
\end{equation}
%
On the other hand, the exchange-correlation kernel arising from $F^2_{\rm xc}$ is diagonal.
Its explicit form derived by perturbation theory (PT) directly reads
%
\begin{equation}
\begin{split}
	\label{eq:ZphPT}
