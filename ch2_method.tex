...
\begin{figure} %%%%%%% FIGURE Coulombic free energy
	...
	\caption{Self-energy diagram of spin fluctuations described with particle-hole propagator $\Lambda$.}
	\label{fig:SF-self}
\end{figure}
...
Particl-hole propagator $\Lambda$ contains all irreducible 
diagrams with respect to Coulomb interaction and has two 
incoming and outgoing points. Now we study the properties of 
particle-hole propagators.In the following, we assume that we 
consider about the case of collinear magnetic systems and 
then the Green's function becomes diagonal with respect to spin indices.
We consider one of the Hedin's equation\cite{Sole1994}
%
\begin{equation}
	\Gamma(1,2,3) = \delta(1,2)\delta(1,3) + 
	\int d(4,5,6,7)\frac{\delta\Sigma(1,2)}{\delta G(4,5)}
