...
same sign and the resulting expression reads as
%
\begin{equation}
	\Sigma^{\rm SF}_F \equiv \iint d34 \tau^{\rm z}
	\begin{pmatrix}
...
%
\begin{equation}
	\Sigma^{\rm SF} \equiv \iint d34 \tau^{\rm z}
	\begin{pmatrix}
...
In the above expression, we omitted the integral and we will use this notation below unless the expression lead any ambiguity. 
