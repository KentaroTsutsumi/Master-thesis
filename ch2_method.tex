...
There are some way how to approximate the screened Coulomb interaction. L\"{u}ders {\it et al.} applied the
Thomas-Fermi interaction to the Coulomb interaction.
We applied RPA in our calculation, so we now summarize the expression of the screened Coulomb interaction in RPA.
Furthermore, it should be taken account of the dynamical structure of the Coulomb interaction which is represented by
frequency-dependent dielectric function $\Pi$.
